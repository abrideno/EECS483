  ...
  main:
	...
	# x = _tmp0
	  ...
	  sw $v0, -8($fp)	# spill x from $v0 to $fp-8
	# _tmp1 = 0
	  li $v0, 0		# load constant value 0 into $v0
	  sw $v0, -24($fp)	# spill _tmp1 from $v0 to $fp-24
	# x = _tmp1
	  lw $v0, -24($fp)	# fill _tmp1 to $v0 from $fp-24
	  sw $v0, -20($fp)	# spill x from $v0 to $fp-20
	# PushParam x
	  subu $sp, $sp, 4	# decrement sp to make space for param
	  lw $v0, -20($fp)	# fill x to $v0 from $fp-20
	...
	# x = _tmp2
	  lw $v0, -32($fp)	# fill _tmp2 to $v0 from $fp-32
	  sw $v0, -24($fp)	# spill x from $v0 to $fp-24
	# y = x
	  lw $v0, -24($fp)	# fill x to $v0 from $fp-24
	  sw $v0, -28($fp)	# spill y from $v0 to $fp-28
	# PushParam x
	  subu $sp, $sp, 4	# decrement sp to make space for param
	  lw $v0, -24($fp)	# fill x to $v0 from $fp-24
	  sw $v0, 4($sp)	# copy param value to stack
